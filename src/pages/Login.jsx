    ...
    style={{
      ...
      <div className="bg-slate-800 p-8 rounded shadow-md w-full max-w-md border-solid border-slate-300 border-2">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="text-white font-semibold w-full py-2 px-4 rounded-md border-2 border-transparent bg-gradient-to-r from-green-400 via-purple-500 to-red-600 bg-clip-border hover:bg-clip-padding hover:text-white hover:bg-gradient-to-r hover:from-green-400 hover:via-purple-500 hover:to-red-600">
            Login bro
          </button>
        </form>
      </div>
